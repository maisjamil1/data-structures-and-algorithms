...
def test_kth_from_end_greater_than_length():
    ...
    anime.append(8)
    anime.append(2)
    assert anime.kth_from_end(5) ==' ValueError '
# ________________________________________________________________
...
def test_kth_from_end_same_length():
    ...
    anime.append(8)
    anime.append(2)
    assert anime.kth_from_end(4) ==' ValueError '
# ________________________________________________________________
...
def test_kth_from_end_not_positive():
    ...
    anime.append(3)
    anime.append(8)
    assert anime.kth_from_end(-1) =="'NoneType' object has no attribute 'val'"
# ________________________________________________________________
...
# ________________________________________________________________
def test_kth_if_k_greater_than_len():
    anime = LinkedList()
    anime.append(3)
    assert anime.kth_from_end(10) ==' ValueError '
# ________________________________________________________________
